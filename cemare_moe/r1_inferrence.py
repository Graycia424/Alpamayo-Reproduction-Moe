...
"""
r1单帧推理复现脚本，展示如何使用 Alpamayo‑R1 模型进行单帧轨迹预测，并将结果可视化叠加在摄像头图像上。
"""
...
@dataclass
class Config:
    clip_id: str = "b991c422-23f2-48fb-8e1f-306b26f4b435"
...
def main() -> None:
    ...
    parser.add_argument(
        "--clip-id",
        type=str,
        default="9bd16005-3f52-425c-b1c3-c06a01f1c66d",
    )
    parser.add_argument(
        "--t0-us",
        type=int,
    ...
    logger.debug("VLM output: ", extra["vlm_output"])
